...
const supportTicketsRoute = require('./routes/support_tickets_route');
const opportunityActionsRoute = require('./routes/opportunity_actions_route');
...
app.use('/api/support_tickets', supportTicketsRoute);
app.use('/api/opportunity_actions', opportunityActionsRoute);
