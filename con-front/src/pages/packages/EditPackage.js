  ...
  const fetchPackageDetails = async () => {
    try {
      ...
      setFormData({
        ...
        total_price_per_sqft: packageData.total_price_per_sqft || '',
        gst_percentage: packageData.gst_percentage || '18.00'
      });
    } catch (error) {
    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="flex items-center space-x-4 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">Update package information and pricing</p>
        </div>
      </div>
        ...
        {formData.total_price_per_sqft && (
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <h2 className="text-lg font-semibold text-gray-900">Updated Pricing Breakdown</h2>
            </div>
