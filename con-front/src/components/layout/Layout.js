...
const Layout = ({ children }) => {
  ...
  const allNavItems = [
    ...
    // CRM workflow (Enquiries → Opportunities → Leads → Clients)
    ...
    { id: 'pkg-customise', label: 'Customise Package',icon: Package,   path: '/sales/packages/customise', perm: 'packages.customise' },
